...
export default function GuestPracticePage() {
  ...
  const handleStopRecording = async () => {
    ...
    const mockTranscript =
      'This is a sample transcript of what you said during your practice session. In a real implementation, this would be generated by the Whisper API.'
    const mockScore = Math.random() * 3 + 7 // Score between 7-10

    setTranscript(mockTranscript)
    setFeedback(
      'Great job! Your speech was clear and confident. Try to reduce filler words like "um" and "uh" for even better clarity.'
    )
